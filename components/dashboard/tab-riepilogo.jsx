          ...
          {[0, 1].map((p) => (
            <button
              ...
              style={{
                width: page === p ? 16 : 6,
                height: 6,
                background: page === p ? "var(--primary)" : "var(--border)",
              }}
            />
          ))}
          <button
                  ...
                  <PieChart>
                    ...
                    >
                      {data.map((c, i) => (
                        <Cell
                          key={c.nome}
                          fill={colorFn(1 - i / Math.max(data.length - 1, 1))}
                        />
                      ))}
                    </Pie>
                    <Tooltip
