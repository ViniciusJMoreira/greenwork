    ...
    >
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <div className={fieldCls}>
          ...
          <input
            {...register("cantiere", { required: true })}
            placeholder="es. Rivazzurra"
            className={inputCls}
          />
        </div>
        <div className={fieldCls}>
          ...
          <input
            {...register("cod_cantiere", { required: true })}
            placeholder="es. 004501V15813"
            className={inputCls}
          />
        </div>
      </div>
      ...
      <div
        ...
        style={{
          background: isAssenza ? "var(--primary-faint)" : "var(--bg-subtle)",
          borderColor: isAssenza ? "var(--primary)" + "44" : "var(--border)",
          transition: "all 0.2s",
        }}
      >
        <div className="flex items-center gap-2.5">
          <BriefcaseMedical
            ...
            style={{
              color: isAssenza ? "var(--primary)" : "var(--text-muted)",
            }}
          />
          <div>
            <p
              className="text-sm font-medium"
              style={{ color: isAssenza ? "var(--primary)" : "var(--text)" }}
            >
    ...
    >
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <div className={fieldCls}>
          ...
          <input
            {...register("mezzo", { required: true })}
            placeholder="es. Grillo FX27"
            className={inputCls}
          />
        </div>
        <div className={fieldCls}>
          ...
          <input
            {...register("cod_mezzo", { required: true })}
            placeholder="es. RS066"
            className={inputCls}
          />
        </div>
      </div>
    ...
    <div className="flex flex-col gap-4">
      <div>
        ...
        <p className="text-sm mt-0.5" style={{ color: "var(--text-muted)" }}>
          Aggiungi cantieri, dipendenti, lavori e macchinari
        </p>
      </div>
      <Sezione id="cantiere" label="Cantiere" icon={Building2}>
        <FormCantiere />
      </Sezione>
      <Sezione id="dipendente" label="Dipendente" icon={Users}>
        <FormDipendente />
      </Sezione>
